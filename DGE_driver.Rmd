...
for(type in types){
  for(tissue in tissues){
    for(comparison in comparisons){
      for(direction in directions){
       de = paste0("..\\data_analysis\\DE_lists\\", genome, tissue, "_", type, "_", limma, comparison, "_P", p, "C", c, "_", direction, ".csv") 

       counts = paste0("..\\data_analysis\\", genome, tissue, "_", type, "_txi.csv")
       
       baseout = paste0("..\\data_analysis\\images\\", genome, tissue, "_", type, "\\", genome, tissue, "_", type, "_", limma,  comparison, "_", direction, "_")
       
       listout = paste0("..\\data_analysis\\GO_lists\\", genome, tissue, "_", type, "_", limma, comparison, "_P", p, "C", c, "_", direction, "_")
