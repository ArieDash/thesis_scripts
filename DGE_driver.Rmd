...
tissues = append(tissues, "CG")
tissues = append(tissues, "GG")
tissues = append(tissues, "BG")
#all samples
tissues = append(tissues, "G")
...
for(regex in tissues){
  for(type in types){
    if(genome == TRUE){
      ...
      samples_location = "..\\mapping\\multi_species_gill"
...
#comparisons = append(comparisons, "UvsE")
#comparisons = append(comparisons, "UvsM")
#comparisons = append(comparisons, "RvsM")
#comparisons = append(comparisons, "MvsC")
#comparisons = append(comparisons, "FvsS")

comparisons = append(comparisons, "EvsC")
comparisons = append(comparisons, "EvsM")
comparisons = append(comparisons, "EvsR")
