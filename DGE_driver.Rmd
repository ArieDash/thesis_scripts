...
for(regex in tissues){
  for(type in types){
    ...
    #input_counts = paste0("..\\data_analysis\\", regex, "_", type, "_corrected_counts.csv")
    
    #Path to output directory for DEG lists
    deg_out = paste0("..\\data_analysis\\DE_lists\\", regex, "_", type, "_")
    #deg_out = paste0("..\\data_analysis\\DE_lists\\", regex, "_", type, "_corrected_")
    
    #Path to output directory for images
    image_out = paste0("..\\data_analysis\\images\\", regex, "_", type, "\\", regex, "_", type, "_")
    #image_out = paste0("..\\data_analysis\\image s\\", regex, "_", type, "_corrected\\", regex, "_", type, "_corrected_")
