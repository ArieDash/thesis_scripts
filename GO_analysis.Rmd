...
if(params$kegg){
  ...
  if(nrow(go_kegg) > 0){
    ...
    #create figure
    PieChart(x = category, y = numDEInCat, hole = 0, values = "%", data = go_kegg, main = "KEGG pathway composition of significantly enriched DE list", pdf_file = paste0(params$baseout, "sig_KEGG.pdf"), width = 12.5)
  }
}
```
...
if(nrow(MF_sig_terms) > 0){
 PieChart(x = term, y = numDEInCat, hole = 0, values = "%", data = MF_sig_terms, main = "Molecular Function GO composition of significantly enriched DE list", pdf_file = paste0(params$baseout, "sig_MF.pdf"), width = 12.5) 
}
```
...
if(nrow(BP_sig_terms) > 0){
  PieChart(x = term, y = numDEInCat, hole = 0, values = "%", data = BP_sig_terms, main = "Biological Process GO composition of significantly enriched DE list", pdf_file = paste0(params$baseout, "sig_BP.pdf"), width = 12.5)
}
```
...
if(nrow(CC_sig_terms) > 0){
  PieChart(x = term, y = numDEInCat, hole = 0, values = "%", data = CC_sig_terms, main = "Cellular Component GO composition of significantly enriched DE list", pdf_file = paste0(params$baseout, "sig_CC.pdf"), width = 12.5)
}
```
