...
MF_all_terms = subset(go_terms, go_terms$ontology == "MF", select = c(term, numDEInCat))
BP_all_terms = subset(go_terms, go_terms$ontology == "BP", select = c(term, numDEInCat))
CC_all_terms = subset(go_terms, go_terms$ontology == "CC", select = c(term, numDEInCat))
