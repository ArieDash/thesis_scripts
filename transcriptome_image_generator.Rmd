...
ggsave(paste0(params$image_out, "species_dist_by_gene_fish_only.png"), width = 12, height = 6, dpi = 300, bg = "white")

plot_bar(tot_group, "accession_id", "Number of Genes", "SwissProt Species Distribution")
ggsave(paste0(params$image_out, "species_dist_by_gene.png"), width = 12, height = 6, dpi = 300, bg = "white")

plot_bar(fisho_trans_group, "transcript_name", "Number of transcripts", "SwissProt Species Distribution (Actinoptyergii only)")
ggsave(paste0(params$image_out, "species_dist_by_transcript_fish_only.png"), width = 12, height = 6, dpi = 300, bg = "white")

plot_bar(tot_trans_group, "transcript_name", "Number of transcripts", "SwissProt Species Distribution")
ggsave(paste0(params$image_out, "species_dist_by_transcript.png"), width = 12, height = 6, dpi = 300, bg = "white")
```
