...
anno_color_opts = c(Eight = "#00d65c",  Six = "#82b7ff", Four = "#9289ff", Two = "#ff9289")
...
```{r}
#make contrasts
contrasts = makeContrasts(TwovsEight=Two-Eight, TwovsSix=Two-Six, TwovsFour=Two-Four, FourvsEight=Four-Eight, FourvsSix=Four-Six, SixvsEight=Six-Eight, levels = design)
```
...
tests = c("TwovsEight", "TwovsSix", "TwovsFour", "FourvsEight", "FourvsSix", "SixvsEight")
