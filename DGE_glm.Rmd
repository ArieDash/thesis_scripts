...
make_heatmap(cpms = cpms, samples = samples, sig_genes = rownames(sig_genes_UC), main = "UvsC significant DEG heatmap", color = cols, annotation_color = list(treatment = anno_color_opts), filename = paste0(params$image_out, "UvsC_deg_heatmap_all_samples.png"))
...
make_heatmap(cpms = cpms, samples = samples, sig_genes = rownames(sig_genes_RC), main = "RvsC significant DEG heatmap", color = cols, annotation_color = list(treatment = anno_color_opts), filename = paste0(params$image_out, "RvsC_deg_heatmap_all_samples.png"))
...
make_heatmap(cpms = cpms, samples = samples, sig_genes = rownames(sig_genes_UR), main = "UvsR significant DEG heatmap", color = cols, annotation_color = list(treatment = anno_color_opts), filename = paste0(params$image_out, "UvsR_deg_heatmap_all_samples.png"))

#save significant DEGs to file
write_sig_genes(sig_genes_UR, "UvsR")

make_heatmap(cpms = cpms, samples = samples, sig_genes = unique(c(rownames(sig_genes_UC), rownames(sig_genes_RC), rownames(sig_genes_UR))), main = "Significant DEG heatmap", color = cols, annotation_color = list(treatment = anno_color_opts), filename = paste0(params$image_out, "sig_deg_heatmap_all_samples.png"))
...
plot(euler(list("UvsC" = rownames(sig_genes_UC), "RvsC" = rownames(sig_genes_RC), "UvsR" = rownames(sig_genes_UR)), shape = "ellipse"), quantities = TRUE)
...
plot(euler(list("UvsC" = rownames(subset(sig_genes_UC, logFC > 0)), "RvsC" = rownames(subset(sig_genes_RC, logFC > 0)), "UvsR" = rownames(subset(sig_genes_UR, logFC > 0))), shape = "ellipse"), quantities = TRUE)
