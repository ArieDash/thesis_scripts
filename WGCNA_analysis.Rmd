...
params:
  input_counts: "..\\data_analysis\\CB_red_filtered_counts.csv"
...
for(module in unique(sigGeneInfo$moduleColor)){
  ...
  write.csv(get_top_n(module, geneInfo, 0.95), paste0("..\\data_analysis\\", "WGCNA_output\\", params$regex, "_sig_module_", module, "_top_n_info.csv"))
}
