...
params:
  input_counts: "..\\data_analysis\\genome_CG_red_filtered_counts.csv"
...
```{r}
write.csv(geneInfo, paste0("..\\data_analysis\\", "WGCNA_output\\", params$gneome, params$regex, "_module_info.csv"))
