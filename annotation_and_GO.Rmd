...
params:
  atm: "..\\annotation\\Zuri_oases_accession_trans_map_new.csv"
...
```
```{r}
temp = merge(atm, py$sw_gene_info)
gtm = data.frame("transcript_name" = temp$transcript_name, "gene_name" = temp$gene_name, "origin" = temp$origin)
