...
```{python}
#payload = {'fields': 'gene_primary,protein_name,cc_function,protein_familes,go_f,go_p,go_c,keyword,cc_tissue_specificity,cc_subcellular_location,cc_pathway,organism_name', 'format':'tsv'}
